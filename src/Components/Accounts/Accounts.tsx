...
const Accounts = () => {
  ...
  // const [accountProfiles, setaccountProfiles] = useState<{account:string,amount:number}>({account:'',amount:0})
  const dispatch = useAppDispatch();

  let handleDelete = (event: MouseEvent<HTMLButtonElement>, email: string) => {
    dispatch({
      type: REMOVE_ACCOUNTS_PROFILE,
      payload: {
        email,
      },
    });
