...
const NavPills = ()=>{
    return (
      ...
      <div className="nav flex-column nav-pills mt-2" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <a className="net_nav_pills" id="v-pills-accounts-tab" data-bs-toggle="pill" href="#v-pills-accounts" role="tab" aria-controls="v-pills-accounts" aria-selected="false">
           Accounts
        </a>
